...
class Movie(models.Model):
    ...
    type = models.CharField(max_length=2, choices=TYPE_CHOICES, default='si', null=True, blank=True)
    STATUS_CHOICES = [
        ('t', 'Trailer'),
        ('o', 'Ongoing'),
        ('c', 'Completed')
    ]
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='t', null=True, blank=True)
    ...
    current_episode = models.DecimalField(max_digits=4, decimal_places=0, null=True, blank=True)
    episode_total = models.DecimalField(max_digits=4, decimal_places=0, null=True, blank=True)
